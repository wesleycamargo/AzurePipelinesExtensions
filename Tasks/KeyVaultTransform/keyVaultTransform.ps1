...
try {
    ...
    $TokenFile = Get-VstsInput -Name TokenFile
    ...
    if ([string]::IsNullOrEmpty($Packages)) {
        ...
        $matchingFiles | ForEach-Object {
            ...
            $replaceCallback = {
                ...
                Write-Host "KeyVault Value: $value"
        ...
        Write-Host "Arquivo zip: $Packages"    
            ...
            try {
                ...
                $matchingFiles | ForEach-Object {
                    ...
                    $replaceCallback = {
                        ...
                        $value = Get-KeyVaultSecret -SecretName $Match.Groups[1].Value -KeyVaultNames $keyVaultNames
